...
namespace Passwordless_Authenticator.Dao_controllers
{
    internal class UserAuthDataController
    {
        ...
        public static List <JObject> selectDomain(string domainName)
        {
            ...
            List<JObject> result = DataAccess.executeQuery(dbpath, DBQueries.SELECT_DOMAIN, parameters);
            return result;
        }
        ...
        public static List <JObject> selectDomainUser(string domainId, string username)
        {
            ...
            string dbpath = Path.Combine(ApplicationData.Current.LocalFolder.Path, AppConstants.DB_NAME);
            List<JObject> result = DataAccess.executeQuery(dbpath, DBQueries.SELECT_DOMAIN_USER, parameters);
            return result;
        }
        ...
        public static string insertDomain(string domainName) {
            ...
            string dbpath = Path.Combine(ApplicationData.Current.LocalFolder.Path, AppConstants.DB_NAME);
            DataAccess.executeQuery(dbpath, DBQueries.INSERT_DOMAIN, parameters);
            return domainId; 
        }
        ...
        public static List<JObject> insertUserAuthData(
            ...
            List<JObject> result = DataAccess.executeQuery(dbpath, DBQueries.INSERT_USER_DATA, parameters);
        ...
        public static List<JObject> getKeyContainerId(string domainName, string username) {
            ...
            string dbpath = Path.Combine(ApplicationData.Current.LocalFolder.Path, AppConstants.DB_NAME);
            List<JObject> result = DataAccess.executeQuery(dbpath, DBQueries.GET_PUBLIC_KEY_ID, parameters);
